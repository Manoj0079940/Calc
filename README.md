...
<head>
    ...
    <style>
        ...
        .button input[type="button"] {
            background-color:black(30, 255, 0);
            height: 50px;
            width: 50px;
            margin: 0 2px;
...
<body style="background-color:aliceblue(85, 16, 126);">
        <h1 align="center" style="color: red;">Simple Calculator</h1>
	<h1 align="center" style="color:cadetblue;">Manoj M (212223230122)</h1>
        <div class="button">
            <center>
...
## OUTPUT:
![image](https://github.com/Manoj0079940/Calc/assets/149366208/277cb1ce-ca0c-4acf-b9e2-ba305309a015)
![image](https://github.com/Manoj0079940/Calc/assets/149366208/f9d0f79c-9b8b-4352-93cf-8cc02db16106)
